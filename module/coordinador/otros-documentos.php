...
<body>
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="#" class="btn btn-warning btn-sm naranja m-2 col-11 sombra-corta3" role="button" style='border-radius: 5px;'> <small><strong>Otros Documentos</strong> </small></a>
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col">
            ...
            <div class="container px-4 centrar" >
                <div class="container pt-4 pb-2 mt-4 mb-2 fadeInDown" style="border-radius: 5px; background-color: #E8EEF4; box-shadow: 0 30px 60px 0 rgba(0,0,0,0.3); ">
                    ...
                    <div class="row align-items-end">
                        <div class="col-1"></div>
                        <div class="col-10">
                            <h3 class="bg-dark text-center " style="border-radius: 5px;"> <p class="text-white">Otros Documentos</p></h3>
                        </div>
                        <div class="col-1"></div>
                    </div>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-12">
                            <button type="button" style='border-radius: 5px;' class="btn btn-sm btn-success float-right add-user mt-3 mb-2 sombra-corta3"  data-toggle="modal" data-target="#add-doc">+ Agregar Nuevo Documento</button>          
                        </div>
    ...
    <!--------------------------------- MODAL PARA CREAR OTRO DOCUMENTO--------------------------->
    <div class="modal fade modal-doc" id="add-doc">
        <div class="modal-dialog">
            <div class="modal-content">
        
                <!-- Modal Header -->
                <div class="modal-header">
                <h4 class="modal-title" id="accion-modal">AÑADIR NUEVO DOCUMENTO</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                ...
                <div class="modal-body">
                    <form id="add-doc-form">
                        ...
                        <div class="form-group">
                            <label for="nombre-doc">Nombre documento:</label>
                            <input class="form-control" type="text"  id="nombre-doc">
                        </div>

                        <label for="">Estado documento:</label>
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="estado-doc" checked="">
                                <label class="custom-control-label" for="estado-doc" id="estado"></label>
                            </div>
                        </div>

                        <br>
                        <div id="boton-modal">
                            <button type="submit" class="text-center btn btn-success btn-block" id='subm-add'>Agregar Documento</button>
                        </div>
                    </form>
                </div>
    ...
    <!--------------------------------- FINAL MODAL PARA CREAR DOCUMENTO--------------------------->

    <!--------------------------------- MODAL PARA CREAR OTRO DOCUMENTO--------------------------->
    <div class="modal fade modal-doc" id="edit-doc">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-doc-form">
                        ...
                        <div class="form-group">
                            <label for="nombre-doc1">Nombre documento:</label>
                            <input class="form-control" type="text"  id="nombre-doc1">
                        </div>

                        <label for="">Estado documento:</label>
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="estado-doc1" checked="">
                                <label class="custom-control-label" for="estado-doc1" id="estado1"></label>
                            </div>
                        </div>

                        <br>
                        <div id="boton-modal">
                            <button type="submit" class="text-center btn btn-success btn-block" id='subm-edit'>Editar Documento</button>
                        </div>
                    </form>
                </div>
    ...
    <script src="../../Resources/js/otros-docs.js"></script>
