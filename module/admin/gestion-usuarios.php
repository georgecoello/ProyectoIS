...
<body>
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        <div class="pt-1 pb-2 mb-2 text-white text-center col-9" style='border-radius: 5px;  background-color: #1e6091'> 
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="#" class="btn btn-warning naranja m-2 col-11 sombra-corta3 btn-sm" id='descarga' role="button" style='border-radius: 5px;'> <small><strong>Ir</strong> </small></a>
                                </div>
                            </div> 
                        </div>
                    <div class="col-1"></div>
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        <div class="pt-1 pb-2 mb-2 text-white text-center col-9" style='border-radius: 5px; background-color: #1a759f '> 
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="gestion-fechas.php" class="btn btn-warning naranja m-2 col-11 btn-sm sombra-corta3" role="button" id='crear-exp' style='border-radius: 5px;'> <small><strong>Ir</strong> </small></a>
                                </div>
                            </div> 
                        </div>
                    <div class="col-1"></div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container px-4 centrar" >
                ...
                <div class="row align-items-end">
                    <div class="col-1"></div>
                    <div class="col-10">
                        <h3 class="bg-dark text-center " style="border-radius: 5px;"> <p style="color:white; ">Gestión Usuarios</p></h3>
                    </div>
                    <div class="col-1"></div>
                </div>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-12">
                        <button type="button" style='border-radius: 5px;' class="btn btn-sm btn-success float-right add-user mt-3 mb-2 sombra-corta3"  data-toggle="modal" data-target="#add-user">+ Agregar Nuevo Usuario</button>          
                    </div>
  ...
  <div class="modal fade modal-usuario" id="add-user">
        <div class="modal-dialog">
            <div class="modal-content">
        
                <!-- Modal Header -->
                <div class="modal-header">
                <h4 class="modal-title" id="accion-modal">AÑADIR NUEVO USUARIO</h4>
                ...
                <div class="modal-body">
                    <form id="add-user-form">
                        ...
                        <div class="form-group">
                            <label for="exampleSelect1">Seleccione rol: </label>
                            <select class="form-control" id="rol-usuario">
                                
                            </select>
                        </div>

                        <label for="">Seleccione estado del nuevo usuario:</label>
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="estado-usuario" checked="">
                                <label class="custom-control-label" for="estado-usuario" id="estado"></label>
                            </div>
                        </div>

                        <br>
                        <div id="boton-modal">
                            <button type="submit" class="text-center btn btn-success btn-block" id='subm-add'>Agregar Usuario</button>
                        </div>
                    </form>
                </div>
    ...
    <!--------------------------------- FINAL MODAL PARA CREAR USUARIO --------------------------->

      <!--------------------------------- MODAL PARA EDITAR USUARIO --------------------------->
    <div class="modal fade modal-usuario" id="edit-user">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-user-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nombres1" placeholder="Nombres" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="apellidos1">Apellidos:</label>
                            <input type="text" id="apellidos1" placeholder="Apellidos" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="correo1">Correo:</label>
                            <input type="email" id="correo1" placeholder="Correo" class="form-control" disabled>
                        </div>

                        <div class="form-group">
                            <label for="exampleSelect1">Seleccione rol: </label>
                            <select class="form-control" id="rol-usuario1">
                                
                            </select>
                        </div>

                        <label for="">Seleccione estado del usuario:</label>
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="estado-usuario1" checked="">
                                <label class="custom-control-label" for="estado-usuario1" id="estado1"></label>
                            </div>
                        </div>

                        <br>
                        <div id="boton-modal">
                            <button type="submit" class="text-center btn btn-warning btn-block" id='subm-edit'>Editar Usuario</button>
                        </div>
                    </form>
                </div>
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                <button type="button" class="btn btn-dark btn-sm reenviar">Reenviar Contraseña</button>
                <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Cancelar</button>
                </div>
    ...
    <!--------------------------------- FINAL MODAL PARA EDITAR USUARIO --------------------------->
