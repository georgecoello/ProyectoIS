...
<head>
    ...
    <title>Descarga Constancia</title>
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right color-bnav" id="sidebar-wrapper">
            ...
            <div class="row text-center">
                ...
                <div class="row text-center">
                    <div class="col-1"></div>
                        <div class="pt-1 pb-1 mb-2 text-white text-center col-9" style='border-radius: 5px; background-color: #3786AB'> 
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="cita.php" class="btn btn-warning naranja m-2 col-11 sombra-corta3 btn-sm " id='cita-estudiante' role="button" style='border-radius: 5px;'> <small><strong>Ir</strong> </small></a>
                                </div>
                            </div> 
                        </div>
                    <div class="col-1"></div>
            ...
            <div class="container px-4 centrar" >
                <div class="container pt-3 pb-1 mt-4 mb-4 fadeInDown sombra redondear" style="background-color: #E8EEF4; ">
                    ...
                    <div class="row align-items-end">
                        <div class="col-1"></div>
                        <div class="col-10">
                            <h3 class="bg-dark text-center " style="border-radius: 5px;"> <p style="color:white;">Descarga Constancia de Egresado</p></h3>
                        </div>
                        <div class="col-1"></div>
                    </div>

                    <div class="row pb-3" id='link-habilitar' hidden>
                        <div class="col-2"></div>
                        <div class="col-8">
                            <div class="row">
                                <div class="col">
                                    <p class='text-center'>Su Constancia de Egresado ya se encuentra disponible, haga click en el siguiente botón para su descarga: </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2"></div>
                                <div class="col-8">
                                    <a href="#" class="btn btn-success btn-block" role="button" id='btn-descarga'>Descargar Constancia</a>
                                </div>
                                <div class="col-2"></div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-8">
                            <p class='text-muted text-center'>Aquí podrá descargar su Constancia de Egresado, una vez que el Coordinador de su carrera la haya subido al sistema. Una
                            vez subida al sistema, aparecerá el link para su descarga</p>
                        </div>
                        <div class="col-2"></div>
                    </div>
    ...
    <script src="../../Resources/js/descarga-expediente.js"></script>
