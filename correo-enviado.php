...
<body style='background-color:#E5F3FF;'>
    ...
    <div class="d-flex justify-content-between align-items-center" style='background-color: #283593 ;'>
            <div>
    ...
    <div class="container my-3">
        <div class="row text-center" style="display: flex; align-items: center; justify-content: center; min-height: 70vh;">
            ...
            <div class="col-8 py-3 px-4 fadeInDown" style='background-color: #ffffff; border-radius: 5px; box-shadow: 0 30px 60px 0 rgba(0,0,0,0.3);'>
                ...
                <h2>¡Se ha enviado el correo satisfactoriamente!</h2>
                <h5 class="pb-3">Se ha enviado a su correo electrónico un link para restablecer su contraseña. Porfavor revisar su correo electrónico.</h5>
